...
export const GROCERS: GrocerData[] = [
  // ─── 1. WALMART ────────────────────────────────────────────────────────────
  {
    ...
    contextStat: [
      ...
      { value: "~10%", label: "SCO transaction share projected to grow at ~10% CAGR over next 3 years" },
    ],
    provocations: [
      {
        number: "01",
  ...
  // ─── 3. COSTCO ─────────────────────────────────────────────────────────────
  {
    ...
    provocations: [
      ...
      },
      {
        ...
        stat: "41% vs. 12%",
        statLabel: "ROI achieved by Platform Builders vs. Transformation Resisters",
        bullets: [
  ...
  // ─── 7. PUBLIX ─────────────────────────────────────────────────────────────
  {
    ...
    provocations: [
      ...
      },
      {
        ...
        stat: "38%",
        statLabel: "of SCO transactions require staff assistance for shoppers 55+",
        bullets: [
  ...
  // ─── 8. TARGET ─────────────────────────────────────────────────────────────
  {
    ...
    provocations: [
      ...
      },
      {
        ...
        stat: "65%",
        statLabel: "of shoppers cite scanner reliability as their top SCO delay",
        bullets: [
